	...
	public static void main (String[] args) 
	{
		...
		for( String [] d : list) 
		{
			try
			{
				...
				ExportToCsv.ExportDfeSummary(frs.getMod106Suppliers("2024", "2024-07-01", null), clientName);  
				ExportToCsv.ExportDfeSummary(frs.getMod106Clients("2024", "2024-07-01", null), clientName);  
