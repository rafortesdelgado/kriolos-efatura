...
import io.github.kriolos.efatura.clientapi.generated.auth.Authentication;
import io.github.kriolos.efatura.clientapi.generated.auth.HttpBasicAuth;
import io.github.kriolos.efatura.clientapi.generated.auth.HttpBearerAuth;
import io.github.kriolos.efatura.clientapi.generated.auth.ApiKeyAuth;
import io.github.kriolos.efatura.clientapi.generated.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    if (auth instanceof OAuth) {
      authentications.put("SecurityScheme", auth);
    } else {
      authentications.put("SecurityScheme", new OAuth(basePath, "https://iam.efatura.cv/auth/realms/taxpayers/protocol/openid-connect/token/introspect"));
    }
