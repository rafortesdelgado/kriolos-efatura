...
import io.github.kriolos.efatura.clientapi.generated.model.PayloadProcessingResponseListTaxPayerCv;
...
public class TaxpayerApi {
   ...
   * @return PayloadProcessingResponseListTaxPayerCv
   ...
   */
  public PayloadProcessingResponseListTaxPayerCv taxPayerResourceSearch(String name, String taxId, String type) throws ApiException {
   ...
   * @param taxId NIF CV de contribuinte. 9 dígitos. (optional)
   * @param type Tipo de contribuinte: S&#x3D;Singular; C&#x3D;Coletivo; N&#x3D;Entidade Nacional; E&#x3D;Entidade Estrangeira; F&#x3D;Fundo de Investimento; H&#x3D;Herança; O&#x3D;Outra Entidade. (optional)
   * @return ApiResponse&lt;PayloadProcessingResponseListTaxPayerCv&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<PayloadProcessingResponseListTaxPayerCv> taxPayerResourceSearchWithHttpInfo(String name, String taxId, String type) throws ApiException {
    ...
    GenericType<PayloadProcessingResponseListTaxPayerCv> localVarReturnType = new GenericType<PayloadProcessingResponseListTaxPayerCv>() {};
