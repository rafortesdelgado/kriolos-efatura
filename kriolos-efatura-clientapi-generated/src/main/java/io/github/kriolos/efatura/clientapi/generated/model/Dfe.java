...
@JsonPropertyOrder({
  ...
  Dfe.JSON_PROPERTY_INNER_DOCUMENT_NUMBER,
...
public class Dfe {
  ...
  private List<DfeTransportLocation> transportRoute = new ArrayList<>();
  ...
  private List<DfeLine> lines = new ArrayList<>();
  ...
  private List<DfeReference> references = new ArrayList<>();
  ...
  public Dfe selfBilling(DfeSelfBilling selfBilling) {
  ...
  public Dfe innerDocumentNumber(String innerDocumentNumber) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, dfe.id) &&
        ...
        Objects.equals(this.innerDocumentNumber, dfe.innerDocumentNumber) &&
