...
public class PayloadProcessingResponseSoftwareTransmitterEntity {
  ...
  private SoftwareTransmitterEntity payload;
  ...
  public PayloadProcessingResponseSoftwareTransmitterEntity payload(SoftwareTransmitterEntity payload) {
  ...
  public SoftwareTransmitterEntity getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(SoftwareTransmitterEntity payload) {
    this.payload = payload;
  }
