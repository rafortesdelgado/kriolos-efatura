...
public class PayloadProcessingResponseSoftwareTransmitterDto {
  ...
  private SoftwareTransmitterDto payload;
  ...
  public PayloadProcessingResponseSoftwareTransmitterDto payload(SoftwareTransmitterDto payload) {
  ...
  public SoftwareTransmitterDto getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(SoftwareTransmitterDto payload) {
    this.payload = payload;
  }
