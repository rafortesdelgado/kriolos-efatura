...
public class PayloadProcessingResponseSoftwareCustomerDto {
  ...
  private SoftwareCustomerDto payload;
  ...
  public PayloadProcessingResponseSoftwareCustomerDto payload(SoftwareCustomerDto payload) {
  ...
  public SoftwareCustomerDto getPayload() {
    return payload;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYLOAD)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayload(SoftwareCustomerDto payload) {
    this.payload = payload;
  }
